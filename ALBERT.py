...
# Fine-tuning ALBERT
def train_albert_model(model, train_loader, val_loader, device, epochs, learning_rate):
    ...
    for epoch in range(epochs):
        ...
        # Validation
        evaluate_albert_model(model, val_loader, device)

    return model

# Evaluate ALBERT Model
def evaluate_albert_model(model, data_loader, device):
    model.eval()
...
def main():
    ...
    model = train_albert_model(model, train_loader, val_loader, device, EPOCHS, LEARNING_RATE)

    # Save the fine-tuned model
    model.save_pretrained('./fine_tuned_albert')
    tokenizer.save_pretrained('./fine_tuned_albert')

    print("ALBERT model fine-tuned and saved!")
